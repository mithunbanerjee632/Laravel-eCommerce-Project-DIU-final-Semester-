                ...
                <div class="our-staff">
                    <div
                        ...
                        <div class="team-member equal-elem">
                            <div class="media">
                                <a href="#" title="LEONA">
                                    <figure><img src="{{asset('assets/images/mithunbanerjee.jpg')}}" alt="Mithun"></figure>
                                </a>
                            </div>
                            <div class="info">
                                <b class="name">Mithun Banerjee</b>
                                <span class="title">CEO</span>
                                <p class="desc">Chief Executive Officer Of renowned Ecommerce Company</p>
                            </div>
                        </div>
                        ...
                        <div class="team-member equal-elem">
                            <div class="media">
                                <a href="#" title="LUCIA">
                                    <figure><img src="{{asset('assets/images/mithunbanerjee.jpg')}}" alt="LUCIA"></figure>
                                </a>
                            </div>
                            <div class="info">
                        ...
                        <div class="team-member equal-elem">
                            <div class="media">
                                <a href="#" title="NANA">
                                    <figure><img src="{{asset('assets/images/mithunbanerjee.jpg')}}" alt="NANA"></figure>
                                </a>
                            </div>
                            <div class="info">
                                <b class="name">NANA</b>
                        ...
                        <div class="team-member equal-elem">
                            <div class="media">
                                <a href="#" title="BRAUM">
                                    <figure><img src="{{asset('assets/images/mithunbanerjee.jpg')}}" alt="BRAUM"></figure>
                                </a>
                            </div>
                            <div class="info">
                        ...
                        <div class="team-member equal-elem">
                            <div class="media">
                                <a href="#" title="NANA">
                                    <figure><img src="{{asset('assets/images/mithunbanerjee.jpg')}}"></figure>
                                </a>
                            </div>
                            <div class="info">
                                <b class="name">NANA</b>
