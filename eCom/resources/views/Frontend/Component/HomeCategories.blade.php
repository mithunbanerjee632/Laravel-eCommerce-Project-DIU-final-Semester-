<div class="wrap-products">
    <div class="wrap-product-tab tab-style-1">
        <div class="tab-control">
            ...
            <a href="/allCategories/{{$category->id}}" class="tab-control-item active">{{$category->category_name}}</a>
            @endforeach
     {{--  @foreach($categories as $category)
          <a href="/allCategories/{{$category->id}}" class="tab-control-item">{{$category->category_name}}}</a>
            @endforeach--}}
